...
export type ListingAction =
  ...
  | { type: typeof LISTING_TYPES.SET_FIELD_VALUE; payload: { field: string; value: any } }
  | { type: typeof LISTING_TYPES.VALIDATE_FIELD; payload: { field: string; error: string | null } }
  | { type: typeof LISTING_TYPES.SET_STEP; payload: number }
  | { type: typeof LISTING_TYPES.ADD_IMAGE; payload: string | File }
  | { type: typeof LISTING_TYPES.REMOVE_IMAGE; payload: { index: number; isUrl: boolean } }
  ...
  | { type: typeof LISTING_TYPES.SET_ACTIVE_SCHEMA; payload: ListingFieldSchema[] }
