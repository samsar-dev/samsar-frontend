...
export const selectCurrentListing = (state: RootState) =>
  state.listingEdit.currentListing;
...
export const selectDeletedImages = (state: RootState) =>
  state.listingEdit.deletedImages;
...
export const selectListingDetails = (state: RootState) =>
  state.listingDetails.listing;
export const selectDetailsLoading = (state: RootState) =>
  state.listingDetails.loading;
