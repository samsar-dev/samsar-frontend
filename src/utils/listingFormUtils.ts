export const prepareListingFormData = (formData: any, images: (File | string)[] = []): FormData => {
...
export const validateListingForm = (formData: any, isEdit: boolean = false): string | null => {
