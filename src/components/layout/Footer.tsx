           ...
           <div>
            ...
            <div className="flex space-x-4">
              ...
              >
                ...
                <span lang="ar" className="inline">
                  <FaFacebook className="w-6 h-6 inline" />
                </span>
              </a>
              <a
                href="#"
        ...
        <div className="border-t border-border-primary dark:border-border-primary-dark pt-6 mt-8">
          <div className="text-center text-sm text-text-secondary dark:text-text-secondary-dark">
            <p className="mb-2">
              {currentYear} &copy;{" "}
              <span aria-hidden="true" className="hidden">
                منصة سمسار. جميع الحقوق محفوظة.
              </span>
              <span lang="ar" className="inline">
                {t("copyright", "منصة سمسار. جميع الحقوق محفوظة.")}
              </span>
            </p>
            <p className="text-xs text-gray-500 dark:text-gray-400">
              <span aria-hidden="true" className="hidden">
                منصة سمسار - بيع وشراء سيارات، عقارات، دراجات نارية، ومحلات
                تجارية في سوريا | إعلانات موثوقة ومجانية
              </span>
              <span lang="ar" className="inline">
                {t(
                  "seo_text",
                  "Simsar - Buy and sell cars, real estate, motorcycles, and commercial properties in Syria | Trusted and free ads",
                )}
              </span>
            </p>
          </div>
