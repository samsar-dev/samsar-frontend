...
import type { ListingCategory, ListingWithRelations, VehicleDetails, RealEstateDetails } from "@/types/listings";
...
export const ListingComponent: React.FC<ListingComponentProps> = ({
  ...
  const ListingCard: React.FC<{
    ...
    const renderDetails = () => {
      ...
      if (listing.mainCategory === 'REAL_ESTATE' && listing.realEstateDetails) {
          ...
          <div className="space-y-1 text-sm">
            ...
            <div className="text-gray-600 dark:text-gray-400">
              ...
              {realEstateDetails.bedrooms && realEstateDetails.bathrooms && (
                <span>
                  {realEstateDetails.bedrooms} {t('common.beds')} • {realEstateDetails.bathrooms} {t('common.baths')}
                </span>
              )}
            </div>
          </div>
