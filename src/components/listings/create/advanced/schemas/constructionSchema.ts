    ...
    options: [
      {
        value: "Excavator",
        label: "EXCAVATOR",
        translationKey: "enums.constructionEquipment.EXCAVATOR",
      },
      {
        value: "Bulldozer",
        label: "BULLDOZER",
        translationKey: "enums.constructionEquipment.BULLDOZER",
      },
      {
        value: "Crane",
        label: "CRANE",
        translationKey: "enums.constructionEquipment.CRANE",
      },
      {
        value: "Forklift",
        label: "FORKLIFT",
        translationKey: "enums.constructionEquipment.FORKLIFT",
      },
      {
        value: "Loader",
        label: "LOADER",
        translationKey: "enums.constructionEquipment.LOADER",
      },
      {
        value: "Backhoe",
        label: "BACKHOE",
        translationKey: "enums.constructionEquipment.BACKHOE",
      },
      {
        value: "Dump Truck",
        label: "DUMP_TRUCK",
        translationKey: "enums.constructionEquipment.DUMP_TRUCK",
      },
      {
        value: "Other",
        label: "OTHER",
        translationKey: "enums.constructionEquipment.OTHER",
      },
    ],
    section: "essential",
    required: true,
