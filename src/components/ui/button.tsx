...
// Define variants as separate constants for better tree-shaking
...
const svgStyles = "[&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0";
...
const buttonVariants = cva(`${baseStyles} ${svgStyles}`, {
  variants: {
    variant: variants,
    size: sizes,
  },
