...
function SecuritySettings({ settings = {}, onUpdate, isRTL }: Props) {
  ...
  return (
    <div className={`space-y-6 ${isRTL ? "rtl" : "ltr"}`}>
          ...
          {mergedSettings.twoFactorEnabled && (
            <div>
              ...
              >
                ...
                <option value="authenticator">{t("settings.authenticatorApp")}</option>
              </select>
            </div>
          )}
        </div>
      ...
      <div>
        <h3 className="text-lg font-medium">{t("settings.loginNotifications")}</h3>
        <div className="mt-4">
          <div className="flex items-start">
            <div className="flex h-5 items-center">
              <input
            ...
            <div key={provider} className="flex items-start">
              <div className="flex h-5 items-center">
                <input
                  ...
                  type="checkbox"
                  checked={mergedSettings.connectedAccounts?.includes(provider) || false}
      ...
      {mergedSettings.loginActivity && mergedSettings.loginActivity.length > 0 && (
        <div>
          <h3 className="text-lg font-medium">{t("settings.recentLoginActivity")}</h3>
          <div className="mt-4">
