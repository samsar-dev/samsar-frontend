            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 w-full px-4 sm:px-0">
               ...
               <div className="group relative overflow-hidden rounded-xl shadow-lg transition-transform duration-300 hover:scale-105">
                <div className="relative h-48 w-full overflow-hidden">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <ImageFallback
                      src="https://pub-363346cde076465bb0bb5ca74ae5d4f9.r2.dev/bmw.jpg"
              ...
              <div className="group relative overflow-hidden rounded-xl shadow-lg transition-transform duration-300 hover:scale-105">
                <div className="relative h-48 w-full overflow-hidden">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <ImageFallback
                      src="https://pub-363346cde076465bb0bb5ca74ae5d4f9.r2.dev/building.jpg"
              ...
              <div className="group relative overflow-hidden rounded-xl shadow-lg transition-transform duration-300 hover:scale-105">
                <div className="relative h-48 w-full overflow-hidden">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <ImageFallback
                      src="https://pub-363346cde076465bb0bb5ca74ae5d4f9.r2.dev/office.jpg"
