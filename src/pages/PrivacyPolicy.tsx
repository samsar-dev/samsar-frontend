...
const PrivacyPolicy = () => {
  ...
  const pageDescription = t('privacy_policy.meta_description', 'تعرف على سياسة الخصوصية لموقع سمسار وكيفية حماية بياناتك الشخصية عند استخدام منصتنا للعقارات والمركبات في سوريا');
  const pageKeywords = t('privacy_policy.meta_keywords', 'سياسة الخصوصية, حماية البيانات, الخصوصية والأمان, معلومات شخصية, حماية المستخدمين, شروط الاستخدام');
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 8 }} dir="rtl">
      ...
      >
        ...
        >
          <Typography variant="h2" component="h2" sx={{ fontWeight: 600, mb: 3, textAlign: 'center' }}>
            {t('privacy_policy.sections.changes_to_policy.title')}
          </Typography>
          <Typography variant="body1" paragraph>
            {t('privacy_policy.sections.changes_to_policy.description')}
          </Typography>
          <Typography variant="h3" component="h3" sx={{ fontWeight: 600, mt: 4, mb: 2 }}>
