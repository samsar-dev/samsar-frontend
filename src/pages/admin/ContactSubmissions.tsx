...
const ContactSubmissions: FC = () => {
  ...
  if (isLoading) {
    return (
      <Box display="flex" justifyContent="center" p={4} flexDirection="column" alignItems="center">
      ...
      <Box p={3}>
        {error && (
          ...
          >
            ...
            {error}
            <Box component="div" sx={{ mt: 1, fontSize: '0.8rem', opacity: 0.8 }}>
                ...
                submissions
                  ...
                  .map((submission) => (
                    <TableRow 
                      ...
                      onClick={async () => await handleViewSubmission(submission)}
                    >
